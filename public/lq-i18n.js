...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      choosePlatformSub: "ست منصات متكاملة للعقارات والضيافة والمحاسبة — اختر مسار عملك",
      realestate: "العقارات",
    ...
    en: {
      ...
      choosePlatformSub: "Six integrated platforms for real estate, hospitality, and accounting — choose your path",
