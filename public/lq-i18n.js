...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      choosePlatformSub: "منصة رسمية لإدارة العقارات والضيافة — اختر مسار عملك",
      realestate: "العقارات",
    ...
    en: {
      ...
      choosePlatformSub: "Official platform for real estate and hospitality — choose your path",
