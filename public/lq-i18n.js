...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      autotrading: "النجار والسموم",
      autotradingDesc: "تجارة واستيراد السيارات — مخزون، مبيعات، واستيراد",
      overview: "نظرة شاملة",
    ...
    en: {
      ...
      autotrading: "Al-Najjar & Al-Sumoom",
      autotradingDesc: "Auto trading & import — inventory, sales, and imports",
    ...
    hi: {
      ...
      autotrading: "अल-नज्जार और अल-सुमूम",
      autotradingDesc: "कार व्यापार और आयात — इन्वेंटरी, बिक्री, आयात",
    ...
    bn: {
      ...
      autotrading: "আল-নাজ্জার ও আল-সুমূম",
      autotradingDesc: "গাড়ি ব্যবসা ও আমদানি — মজুদ, বিক্রয়, আমদানি",
    ...
    ur: {
      ...
      autotrading: "النجار والسموم",
      autotradingDesc: "کاروں کی تجارت و درآمد — انوینٹری، فروخت، درآمد",
