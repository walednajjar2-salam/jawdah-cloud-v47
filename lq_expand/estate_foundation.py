...
PHASE1_AUDIT = {
    ...
    "incomplete": [
        "estate property/building create UI",
        "client needs / viewings / follow-ups modules",
        "first-class receipts",
        "employee photo avatars",
        "dashboard ignoring estate ledger",
        "reservation without mandatory client_id (fixed in this foundation)",
        "estate pay without payments/receipts rows (fixed in this foundation)",
    ],
    "mandatory_order": [
        "save",
        "autofill",
